...
const Footer = () => {
  const footerLinks = {
    Platform: ['For Farmers', 'For Buyers', 'Market Data', 'Pricing'],
  ...
  return (
    <footer className="bg-bazaar-card border-t border-gray-700/30 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Connecting farmers to better markets through technology and transparent pricing.
            </p>
        ...
        <div className="border-t border-gray-700/30 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 Bazaar. All rights reserved.
          </p>
          <div className="flex items-center space-x-4 mt-4 md:mt-0">
            <span className="text-gray-400 text-sm">Made with ❤️ for farmers</span>
          </div>
        </div>
      </div>
    </footer>
